  ...
  <div id="gridContainer">
    <div class="gridItem one">
      <div v-for="(product, index) in products" :key="index">
          <div class="container">
          <div class="headline"><h1><router-link to="`/product/${product.product_id}`" class="routerlink">{{ product.product_name }}</router-link></h1></div>
          <div class="image"><router-link to="`/product/${product.product_id}`"><img :src="'./src/assets/' + product.image_name" /></router-link></div>
